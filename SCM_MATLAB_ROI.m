...
uicontrol('Parent',panelCtrl,'Style','pushbutton','Units','normalized','Position',[0.01 0.42 0.07 0.50], ...
...
uicontrol('Parent',panelCtrl,'Style','text','Units','normalized','Position',[0.32 0.62 0.05 0.28], ...
    'String','Tiles:','BackgroundColor','w','HorizontalAlignment','right','FontWeight','bold');
valTiles = 1 + (default_tiles==8);
pop_tiles = uicontrol('Parent',panelCtrl,'Style','popupmenu','Units','normalized','Position',[0.38 0.62 0.07 0.28], ...
